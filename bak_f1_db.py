...
if not os.path.isfile(db): # Create default table
    ...
    con.commit()
    ##### Preinstalled data #####
    cur.execute(f"""INSERT INTO {t_std_name} VALUES (0, 'Buday', 'Marc')""")
    cur.execute(f"""INSERT INTO {t_std_sub} VALUES (1, 'ObjOrientedProg',10,10,10)""")
    cur.execute(f"""INSERT INTO {t_std_mark} VALUES (0, 'quiz', 1 ,5, 5, 1)""")
    con.commit()
    con.close()
                    ...
                    while std_grade_edit_id_len==9:
                        ...
                        while found==1:
                            ...
                            while True:
                                ...
                                for sub in course_read:
                                    while std_grade_edit_sub_data==sub[0]:
                                        match=1
                                    ...
                                    while edit_trig==1:
                                        ...
                                        try:
                                            ...
                                            for out in filtered_out_ass+filtered_out_quiz+filtered_out_exam:
                                                if out[5]==std_grade_edit_sub_data:
                                                    if edit_out_where==out[2]: #and out[5]==std_grade_edit_sub_data:
                                                        print(out)
                                                        break
                                        except ValueError:
                                            print('\n   [!] Error input!')
